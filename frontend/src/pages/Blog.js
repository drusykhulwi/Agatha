    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="relative w-full h-80 md:h-96 mb-8">
          <img src="https://images.pexels.com/photos/129112/pexels-photo-129112.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="White House" className="w-full h-full object-cover" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {[1, 2, 3].map((blog) => (
            <div key={blog} className="flex flex-col">
              <img src="https://images.pexels.com/photos/7583367/pexels-photo-7583367.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Medical professionals" className="w-full h-48 object-cover mb-4" />
